...
size_t EchoMsgResponser::get_require_size() { return mini_size_; }

void EchoMsgResponser::do_it_for_con_of_seqno(uint32_t seqno, Buffer& rb,
                                              Buffer& wb) {
...
void EchoMsgResponser::register_cb_for_con_of_seqno(
    uint32_t seqno, MsgResponserDoCallBack&& cb) {
